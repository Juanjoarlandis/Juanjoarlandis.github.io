...
if __name__ == "__main__":
    # Ejemplo de uso
    source_dirs = [
        "/home/juanjo/juanjoarlandis.github.io"
    ]
    exclude_dirs = ["node_modules", "build", "dist", "data",".git", "waltid-identity","__pycache__"]
    exclude_files = ["package-lock.json", "logs.log","verifier_logs.log", "copiar.py", "App.css" , "Register.css", "Dashboard.css", "todo_junto.json", "todo_junto.txt","resultado_noticias.json","daily_newsletters.json","used_news_details.json"]  # Añade aquí los archivos a excluir
